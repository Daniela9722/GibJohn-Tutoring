    ...
    <div class="sign-container">
        <div class="sign-form">
            ...
            <form class="sign-input-fields" action="../models/student-signin.php" method="POST">
                ...
                <!--A button for submitting the log in form-->
                <button class="sign-in-button" type="submit" name="student-sign-in">Sign In</button>
                <!--Adds a link to the student log in if the user doesn't have an account yet-->
