    ...
    <div class="sign-container">
        <div class="sign-form">
            ...
            <form class="sign-input-fields" action="#" method="post">
                ...
                <!--Adds a button to submit the log in form-->
                <button class="sign-in-button" type="submit" name="tutor-sign-in">Sign In</button>
                <!--Adds a link fot the tutor sign up if the user doesn't have an account-->
                <p class="dont-have-an-account">Don't have an account? <a class="sign-link-redirect" href="sign-up-tutor.php">Sign Up</a></p>
            </form>
        ...
        <div class="sign-image">
            <img src="/static/9963615.jpg" alt="Tutor teaching a student">
        </div>
    </div>
